...
//    DATABASE TOOLS
    ...
    public void loginAccount() {
        ...
        if (login_username.getText().isEmpty()
            ...
            try {
                ...
                prepare.setString(2, "Pendaftaran");
                ...
                if (result.next()) {
                    ...
                    if (BCrypt.checkpw(passwordText, storedPassword)) {
                        ...
                        // pindahh ke tampilan  Main pendaftaran
                        Parent root = FXMLLoader.load(getClass().getResource("pendaftaranMainform.fxml"));
                        Stage stage = new Stage();
                        stage.setTitle("Sistem Pelayanan Puskeswan | Pendaftaran Portal");
    ...
    public void registerAccount() {
        ...
        if (register_nama.getText().isEmpty()
                || register_username.getText().isEmpty()
                || register_password.getText().isEmpty()
                || register_konfirpassword.getText().isEmpty()) {
    ...
    public void switchPage() {
        ...
        if (login_user.getSelectionModel().getSelectedItem() == "Pendaftaran Portal") {
            ...
            try {
                ...
                stage.setTitle("Sitem Pelayanan Puskeswan");
